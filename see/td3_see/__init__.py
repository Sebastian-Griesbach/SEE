...
from td3_see.policy import INFO_KEY_UNSCALED_ACTION, TD3SEEPolicyBuilder
from td3_see.update import TD3SEEUpdateRule


# This file defines the default configuration for
# Twin Delayed Deep Deterministic Policy Gradient + Stable Error-seeking Exploration
...
ARGUMENT_EXPLOITATION_TARGET_NOISE_STD = "exploitation_target_noise_std"
ARGUMENT_EXPLOITATION_TARGET_NOISE_CLIP = "exploitation_target_noise_clip"
ARGUMENT_EXPLORATION_TARGET_NOISE_STD = "exploration_target_noise_std"
ARGUMENT_EXPLORATION_TARGET_NOISE_CLIP = "exploration_target_noise_clip"
...
ARGUMENT_EXPLOITATION_TARGET_ACTOR_UPDATE_FREQUENCY = (
    "exploitation_target_actor_update_frequency"
)
ARGUMENT_EXPLOITATION_TARGET_ACTOR_TAU = "exploitation_target_actor_tau"
...
ARGUMENT_EXPLORATION_TARGET_ACTOR_UPDATE_FREQUENCY = (
    "exploration_target_actor_update_frequency"
)
ARGUMENT_EXPLORATION_TARGET_ACTOR_TAU = "exploration_target_actor_tau"
...
DEFAULT_CONFIGURATION = {
    ...
    ARGUMENT_EXPLOITATION_TARGET_NOISE_STD: 0.2,
    ARGUMENT_EXPLOITATION_TARGET_NOISE_CLIP: 0.5,
    ARGUMENT_EXPLOITATION_ACTOR_NETWORK_CLASS: FCDeterministicActor,
    ...
    ARGUMENT_EXPLORATION_ACTOR_NETWORK_CLASS: FCDeterministicActor,
    ...
    ARGUMENT_EXPLOITATION_CRITIC_OPTIMIZER_ARGUMENTS: {"lr": 1e-3},
    ARGUMENT_EXPLOITATION_ACTOR_OPTIMIZER_CLASS: torch.optim.Adam,
    ARGUMENT_EXPLOITATION_ACTOR_OPTIMIZER_ARGUMENTS: {"lr": 1e-3},
    ARGUMENT_EXPLORATION_CRITIC_OPTIMIZER_CLASS: torch.optim.Adam,
    ARGUMENT_EXPLORATION_CRITIC_OPTIMIZER_ARGUMENTS: {"lr": 1e-3},
    ARGUMENT_EXPLORATION_ACTOR_OPTIMIZER_CLASS: torch.optim.Adam,
    ARGUMENT_EXPLORATION_ACTOR_OPTIMIZER_ARGUMENTS: {"lr": 1e-3},
    ...
    ARGUMENT_EXPLOITATION_ACTOR_UPDATE_FREQUENCY: 2,
    ...
    ARGUMENT_EXPLORATION_ACTOR_UPDATE_FREQUENCY: 2,
    ARGUMENT_EXPLORATION_ACTOR_NUMBER_OF_UPDATES: 1,
    ARGUMENT_MULTIPLY_NUMBER_OF_UPDATES_BY_ENVIRONMENT_STEPS: False,
    ARGUMENT_EXPLOITATION_TARGET_CRITIC_UPDATE_FREQUENCY: 2,
    ARGUMENT_EXPLOITATION_TARGET_CRITIC_TAU: 0.005,
    ARGUMENT_EXPLOITATION_TARGET_ACTOR_UPDATE_FREQUENCY: 2,
    ARGUMENT_EXPLOITATION_TARGET_ACTOR_TAU: 0.005,
    ARGUMENT_EXPLORATION_TARGET_CRITIC_UPDATE_FREQUENCY: 2,
    ARGUMENT_EXPLORATION_TARGET_CRITIC_TAU: 0.005,
    ARGUMENT_EXPLORATION_TARGET_ACTOR_UPDATE_FREQUENCY: 2,
    ARGUMENT_EXPLORATION_TARGET_ACTOR_TAU: 0.005,
    ARGUMENT_EXPLOITATION_TARGET_NOISE_STD: 0.2,
    ARGUMENT_EXPLOITATION_TARGET_NOISE_CLIP: 0.5,
    ARGUMENT_EXPLORATION_TARGET_NOISE_STD: 0.2,
    ARGUMENT_EXPLORATION_TARGET_NOISE_CLIP: 0.5,
...
def make_td3_see_components(
    ...
    Returns:
        Tuple[DataCollector, UpdateRule, PolicyBuilder]: The data collector, update rule, and policy builder for the TD3+SEE algorithm.
    """

    if not isinstance(observation_space, Box):
        raise ValueError(
            f"This TD3+SEE implementation only supports Box observation spaces, but got {type(observation_space)}"
        )
    if not isinstance(action_space, Box):
        raise ValueError(
            f"This TD3+SEE implementation only supports Box action spaces, but got {type(action_space)}"
        )
    ...
    update_rule = TD3SEEUpdateRule(
        ...
        exploitation_target_actor_update_frequency=configuration[
            ARGUMENT_EXPLOITATION_TARGET_ACTOR_UPDATE_FREQUENCY
        ],
        exploration_target_critic_update_frequency=configuration[
            ARGUMENT_EXPLORATION_TARGET_CRITIC_UPDATE_FREQUENCY
        ],
        exploration_target_actor_update_frequency=configuration[
            ARGUMENT_EXPLORATION_TARGET_ACTOR_UPDATE_FREQUENCY
        ],
        exploitation_target_critic_tau=configuration[
            ARGUMENT_EXPLOITATION_TARGET_CRITIC_TAU
        ],
        exploitation_target_actor_tau=configuration[
            ARGUMENT_EXPLOITATION_TARGET_ACTOR_TAU
        ],
        exploration_target_critic_tau=configuration[
            ARGUMENT_EXPLORATION_TARGET_CRITIC_TAU
        ],
        exploration_target_actor_tau=configuration[
            ARGUMENT_EXPLORATION_TARGET_ACTOR_TAU
        ],
        exploitation_target_noise_std=configuration[
            ARGUMENT_EXPLOITATION_TARGET_NOISE_STD
        ],
        exploitation_target_noise_clip=configuration[
            ARGUMENT_EXPLOITATION_TARGET_NOISE_CLIP
        ],
        exploration_target_noise_std=configuration[
            ARGUMENT_EXPLORATION_TARGET_NOISE_STD
        ],
        exploration_target_noise_clip=configuration[
            ARGUMENT_EXPLORATION_TARGET_NOISE_CLIP
        ],
    ...
    policy_builder = TD3SEEPolicyBuilder(
        exploration_actor=exploration_actor,
        exploration_critic=exploration_critic_1,
        exploitation_actor=exploitation_actor,
        exploitation_critic=exploitation_critic_1,
...
athlete.register(
    id="td3+see",
    component_factory=make_td3_see_components,
