...
class SparseSwimmerEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release.
    ...
    def __init__(
        ...
        ctrl_cost_weight: float = 0.0,  # original value is 1e-4
    ...
    def _get_rew(self, xy_position_after: float, action):
        x_position = xy_position_after[0]
        sparse_reward = 0.0 if x_position < self._goal_distance else 1.0
...
class AdverseSparseSwimmerEnv(SparseSwimmerEnv):
    def __init__(
        self,
        ...
        default_camera_config={},
        goal_distance=2,
        ctrl_cost_weight=1e-4,  # this is the original value of the environment
